/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ef5f2b56d5c062cf109f2438c07a1f1d)
// Runtime types generated with workerd@1.20260918.1 2026-09-19
interface __BaseEnv_Env {
	DEMO_ENABLED: "true";
	DEPLOYMENT_ENV: "production";
	BUDGET_COORDINATOR: DurableObjectNamespace<import("./src/index").DemoBudgetCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DemoBudgetCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEMO_ENABLED" | "DEPLOYMENT_ENV">> {}
}
